    ...
    def read_scanrec_from_ff(self, datapath):
        ...
        try:
            ...
            try:
                ...
                print("Unknown pointing:", obsinfo['pointing'])
                direction = None
    ...
    for bst_polfile in bst_files:
        ...
        if pol == 'X' or pol == 'XX':
            ...
            file_start_dt = datetime.datetime.strptime(Ymd + '_' + HMS,
                                                       '%Y%m%d_%H%M%S')
            intg_true, _ = integrate_int_samples(intg, 200e6)
            file_dur = filedata.shape[0]*intg_true
            ts_rel = numpy.arange(0., file_dur, intg_true)
            file_ts =\
